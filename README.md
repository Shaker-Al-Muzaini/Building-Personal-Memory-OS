<div align="center">
  ...
  <img src="./public/cover.png" alt="Memory OS Cover" width="800" style="border-radius: 20px; box-shadow: 0 0 30px rgba(6,155,255,0.4);"/>
  
  <br/>
  <h1>🧠 Personal Memory OS</h1>
  <p><b>Your Smart Digital Experience & Second Brain</b></p>
  <p><i>ليس مجرد موقع، بل هو عقلك الثاني المُعزز بالذكاء الاصطناعي</i></p>
  ...
  <div>
    ...
    <img src="https://img.shields.io/badge/AI-Powered-069BFF?style=for-the-badge&logo=openai&logoColor=white" />
  </div>
</div>
...
*   **الواجهة الخلفية (Backend):** Laravel 11 (PHP 8.2) مع قاعدة بيانات MySQL.
...
## ⚙️ التثبيت والتشغيل المحلي (Installation)
...
# 5. تشغيل أوامر قواعد البيانات
php artisan migrate

# 6. تشغيل السيرفر المحلي وخوادم الـ Vite
php artisan serve
npm run dev
```
...
<br>
<div align="center">
  <p>صُنع بشغف 💙 ليكون عقلك القادم</p>
</div>
